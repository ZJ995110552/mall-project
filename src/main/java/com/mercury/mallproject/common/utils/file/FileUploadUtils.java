package com.mercury.mallproject.common.utils.file;

import com.mercury.mallproject.common.exception.file.FileNameLengthLimitExceededException;
import com.mercury.mallproject.framework.config.WebSysConfig;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = WebSysConfig.getProfile();
