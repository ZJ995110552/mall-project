...
layui.define("jquery", function (i) {
    ...
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child",
        h = "layui-nav-more", f = "layui-anim layui-anim-upbit", y = {
            tabClick: function (i, a, s) {
                ...
                var i = t(this), a = i.parents(o), n = a.attr("lay-filter");
                i.addClass(l).siblings().removeClass(l), layui.event.call(this, e, "nav(" + n + ")", i)
            }, showChild: function () {
    ...
    s.prototype.init = function (i) {
        var e = {
            tab: function () {
                ...
                var i, e, l, s = 200, b = function (o, c) {
    ...
    var b = new s, p = t(document);
    b.init();
    var v = ".layui-tab-title li";
    p.on("click", v, y.tabClick), p.on("click", y.hideTabMore), t(window).on("resize", y.tabAuto), i(e, function (i) {
        return b.set(i)
    })
});
