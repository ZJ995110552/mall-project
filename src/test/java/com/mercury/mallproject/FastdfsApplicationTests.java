...
public class FastdfsApplicationTests {
    ...
    public void testUpload() throws FileNotFoundException {
        ...
        StorePath storePath = fastdfsService.uploadFileAndUpdateFileDetail(new FileInputStream(file), file.length(), fileExtName, metaDataSet);
//        StorePath storePath = fastdfsService.uploadFile(new FileInputStream(file), file.length(), fileExtName, metaDataSet);
    ...
    public void print1(){
        ...
        String s = StringUtils.substringAfterLast(aa, File.separator);
